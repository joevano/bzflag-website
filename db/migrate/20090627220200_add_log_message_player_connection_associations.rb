...
#-------------------------------------------------------------------------------
class AddLogMessagePlayerConnectionAssociations < ActiveRecord::Migration
  def self.up
    add_column :log_messages, :player_connection_id, :integer
  end

  def self.down
    remove_column :log_messages, :player_connection_id
  end
end
